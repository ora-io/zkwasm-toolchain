...
async function instantiate(module, imports = {}) {
    ...
    const adaptedExports = Object.setPrototypeOf({
        asmain_local(rawreceipts, matched_event_offsets) {
            ...
            rawreceipts = __retain(__lowerTypedArray(Uint8Array, 4, 0, rawreceipts) || __notnull());
            matched_event_offsets =
                __lowerTypedArray(Uint32Array, 5, 2, matched_event_offsets) ||
                    __notnull();
            try {
                return __liftTypedArray(Uint8Array, exports.asmain(rawreceipts, matched_event_offsets) >>> 0);
            }
            finally {
        ...
        asmain() {
            ...
            try {
                return __liftTypedArray(Uint8Array, exports.asmain() >>> 0);
            }
            catch (e) {
    ...
    function __liftTypedArray(constructor, pointer) {
        if (!pointer)
            return null;
        return new constructor(memory.buffer, __getU32(pointer + 4), __dataview.getUint32(pointer + 8, true) / constructor.BYTES_PER_ELEMENT).slice();
    }
...
export const instantiateWasm = async (wasmUnit8Array) => {
    return instantiate(await (async () => {
        return globalThis.WebAssembly.compile(wasmUnit8Array.buffer);
    })(), {});
};
